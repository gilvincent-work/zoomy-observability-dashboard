...
export const MOCK_POS_ORDERS: PosOrder[] = [
  {
    id: 'mock-1', subtotal: 540, discount: null, total: 540, oversold: false, device_id: 'pos', payment_method: 'cash', created_at: iso(0, 9),
    items: [
  ...
  {
    id: 'mock-2', subtotal: 300, discount: null, total: 300, oversold: true, device_id: 'pos', payment_method: 'gcash', created_at: iso(0, 14),
    items: [{product_id: 'ZMYFDJRKCHKWHL01', name: 'Tasty Treats Chicken Jerky', qty: 1, unit_price: 300, line_total: 300}],
  },
  {
    id: 'mock-3', subtotal: 340, discount: null, total: 340, oversold: false, device_id: 'pos', payment_method: 'card', created_at: iso(3),
    items: [{product_id: 'ZMYFDFDRBEFLVR01', name: 'Freeze-Dried Beef Liver Cubes', qty: 2, unit_price: 170, line_total: 340}],
  },
  {
    id: 'mock-4', subtotal: 200, discount: null, total: 200, oversold: false, device_id: 'pos', payment_method: 'gcash', created_at: iso(12),
    items: [{product_id: 'ZMYFDMEATBEFWHL01', name: 'Meaty Treats Beef', qty: 1, unit_price: 200, line_total: 200}],
  },
  {
    id: 'mock-5', subtotal: 510, discount: null, total: 510, oversold: false, device_id: 'pos', payment_method: 'cash', created_at: iso(25),
    items: [
